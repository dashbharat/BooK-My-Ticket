...
import { Contact, Contact2Icon, MenuIcon, SearchIcon, TicketPlus, XIcon } from "lucide-react";
          ...
          <UserButton>
             <UserButton.MenuItems>
                 <UserButton.Action label="My Bookings" labelIcon={<TicketPlus width={15} />} onClick={()=>navigate('/my-Bookings')} />
                  <UserButton.Action label="ContactUs" labelIcon={<Contact width={15} />} onClick={()=>navigate('/ContactUs')} />
              </UserButton.MenuItems>
          </UserButton>  
        )
       }
